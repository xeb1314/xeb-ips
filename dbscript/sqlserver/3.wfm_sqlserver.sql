...
(
	...
	FIELD_1 nvarchar(200),
	FIELD_2 nvarchar(200),
...
(
	...
	ACT_CLASS INT,
	ACT_ICON nvarchar(200),
	ACT_DESC nvarchar(200),
	TIME_LIMIT INT,
	ACTION nvarchar(500),
	CONCURRENT_NUM INT,
...
(
	...
	PROC_TYPE  INT NOT NULL DEFAULT 0,
	PROC_STATE INT,
	PROC_DESC nvarchar(300),
...
(
	PROCACT_ID INT NOT NULL,
	ASSIGN_TYPE INT,
	ASSIGN_OBJID nvarchar(50),
	ASSIGN_PARAM nvarchar(100),
	FIELD_1 nvarchar(200),
...
(
	...
	EXECUTE_USER nvarchar(50),
	EXECUTE_USERID VARCHAR(50),
	CREATE_USER nvarchar(50),	
	TASK_STATE INT NOT NULL DEFAULT 0,
	TASK_PERCENT INT,
	TASK_PARAM nvarchar(1000),
	TASK_DESC nvarchar(500),
	BACK_TIMES int,
	EXT_SYSID INT,
	EXT_STATE INT,
...
(
	...
	EXECUTE_USERID VARCHAR(50),
	CREATE_USER     nvarchar(50),
	RECEIVE_USER    nvarchar(200),
	OLD_STATE	INT,
	OVER_STATE	INT,
	TASK_DESC   nvarchar(500),
	NTASK_DESC  nvarchar(500),
	TASK_PARAM  nvarchar(1000),
...
--==============================================================
--TABLE: WFM_PROCVER 流程添加版本管理 20150715
--==============================================================
...
(
   ...
   CONSTRAINT P_NET_SEQUENCE PRIMARY KEY (TABLE_NAME)
) ;
...
--INSERT INTO NET_CTRLWORD (CW_ID,CW_SYS,CW_TYPE,CW_NAME,CW_CODE,CW_DESC) VALUES (1310, 22, 2201, '信息处理', '800', '');
