 ...
 * Version: 0.7.11
 */
jetsennet.require(["jqueryui/jquery-ui","iviewer/jquery.mousewheel.min"]);
( function( $, undefined ) {
...
$.widget( "ui.iviewer", $.ui.mouse, {
    ...
    **/
    createui: function()
    {
        ...
        $(".iviewer_button").each(function(){
        	$(this).mousedown(function(){
        		$(this).css("background-image",$(this).css("background-image").replace(".png","1.png"));
        	}).mouseup(function(){
        		$(this).css("background-image",$(this).css("background-image").replace("1.png",".png"));
        	});
        });
    }
