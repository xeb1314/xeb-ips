 ...
 * 文件：jetsennet.wfm.schema.Taskexec.java
 ...
 * @version 1.0.0
 */
@ClassMapping(tableName = "WFM_TASKEXEC", keyGenerator = "java.util.UUID")
public class Taskexec implements Serializable {
	...
	public Taskexec(Integer actId, Date createTime, Date endTime, String objId, Integer procactId, String procexecId, Integer procType, Date startTime, Integer taskState) {
		this.actId = actId;
