 ...
 * 文件：jetsennet.wfm.schema.Procexec.java
 ...
 * @version 1.0.0
 */
@ClassMapping(tableName = "WFM_PROCEXEC", keyGenerator = "java.util.UUID")
public class Procexec implements Serializable {
	...
	public Procexec(String procexecId) {
		this.procexecId = procexecId;
	}

	public Procexec(Date endTime, Integer objType, Integer procId, Integer procState, Integer procType, Date startTime) {
	...
	public boolean equals(Object o) {
		if ((o == null) || !(o instanceof Procexec)) {
			return false;
		}
		Procexec other = (Procexec)o;
