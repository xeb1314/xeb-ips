 ...
 * 文件：jetsennet.mtc.schema.Taskexec.java
 ...
 * @version 1.0.0
 */
@ClassMapping(tableName = "MTC_TASKEXEC", keyGenerator = "java.util.UUID")
public class TaskExec implements Serializable {
	...
	public TaskExec(String taskId) {
		this.taskId = taskId;
	}

	public TaskExec(Date createTime) {
	...
	public boolean equals(Object o) {
		if ((o == null) || !(o instanceof TaskExec)) {
			return false;
		}
		TaskExec other = (TaskExec)o;
		if (null == this.taskId) {
